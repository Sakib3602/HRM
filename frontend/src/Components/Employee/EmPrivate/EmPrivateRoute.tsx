...
const EmPrivateRoute: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const { isAuthenticated, isEmployee, isLoading } = useContext(AuthContext)!;
