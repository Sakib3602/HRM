        ...
        <div className="bg-[#101826] text-[#B8C0CC] py-2.5 hidden md:block text-sm border-b border-[#2A3850]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            <div className="flex items-center gap-2 font-medium">
              <span className="bg-[#E7A33E] text-[#101826] text-xs font-bold px-2 py-0.5 rounded-full uppercase tracking-wide">
                New
              </span>
        ...
        <div className="bg-[#F3EFE6] border-b border-[#DCD5C4] sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              ...
              >
                <div
                  className="w-10 h-10 bg-[#101826] rounded flex items-center justify-center text-[#E7A33E] font-bold text-xl"
                  style={{ fontFamily: "Fraunces, serif" }}
                >
                  G
                </div>
                <span
                  className="text-xl font-semibold text-[#101826] tracking-tight"
                  style={{ fontFamily: "Fraunces, serif" }}
                >
              ...
              <nav className="hidden lg:flex space-x-9 items-center">
                ...
                <a
                  href="#"
                  className="text-[#101826] font-medium hover:text-[#E7A33E] transition-colors"
                >
                  Solutions
                </a>
                <a
                ...
                {isLoading ? (
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <span className="text-[#101826] font-medium text-sm">
                        {user?.name}
                      </span>
                      <FiChevronDown
                        size={14}
                        className={`text-[#101826] transition-transform ${showUserMenu ? "rotate-180" : ""}`}
                      />
                    </button>
                    ...
                    {showUserMenu && (
                      <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-[#DCD5C4] overflow-hidden">
                        <div className="px-4 py-3 border-b border-[#DCD5C4]">
                          <p className="text-[#101826] font-semibold text-sm truncate">
                            {user?.name}
                          </p>
                          <p className="text-[#8A8272] text-xs truncate">
                            {user?.email}
                          </p>
          ...
          {isOpen && (
            <div className="lg:hidden bg-[#F3EFE6] border-t border-[#DCD5C4] pb-4 shadow-xl absolute w-full left-0">
              <div className="flex flex-col space-y-3 px-6 pt-4">
                <a
                  href="#"
                  className="text-[#101826] font-medium hover:text-[#E7A33E]"
                >
                  Products
                </a>
                <a
                ...
                {isAuthenticated ? (
                  <>
                    <div className="px-2 py-2">
                      <p className="text-[#101826] font-semibold text-sm">
                        {user?.name}
                      </p>
                  ...
                  <>
                    <Link
                      to="/get-started"
                      className="text-[#101826] font-medium hover:text-[#E7A33E] text-center py-2 border border-[#DCD5C4] rounded"
                    >
                      Log in
                    </Link>
